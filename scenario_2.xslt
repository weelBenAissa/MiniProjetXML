...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <h1>Séjours Linguistiques Scolaires dont le prix est inférieur à 20000000 :</h1>
                <table>
                    <tr>
                        <th>Destination</th>
                        ...
                        <xsl:for-each select="centre_de_sejours_linguistiques/offre_de_sejour_linguistique/sejour_linguistique[type_de_sejour/groupes_scolaires][prix &lt; 20000000]">
                    <tr>
